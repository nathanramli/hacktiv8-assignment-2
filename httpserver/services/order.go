...
import (
	"github.com/nathanramli/hacktiv8-assignment-2/httpserver/controllers/params"
	"github.com/nathanramli/hacktiv8-assignment-2/httpserver/controllers/views"
	"github.com/nathanramli/hacktiv8-assignment-2/httpserver/repositories"
	"github.com/nathanramli/hacktiv8-assignment-2/httpserver/repositories/models"
	"net/http"
)
...
func (s *OrderSvc) CreateOrder(req *params.CreateOrderRequest) *views.Response {
	...
	return views.SuccessResponse(http.StatusCreated, views.M_CREATED, nil)
}
...
func (s *OrderSvc) FindAllOrder() *views.Response {
	...
	return views.SuccessResponse(http.StatusOK, views.M_OK, vOrders)
}
